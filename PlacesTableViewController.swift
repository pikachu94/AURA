...
class PlacesTableViewController: UITableViewController {
    ...
    func loadPLaces(){
        ...
        let place1 = Place(name: "Spider House Cafe", description: "Food, Drinks, Coffee", categories: ["lgbtq": true, "bathroom": false, "open_carry": false, "wheelchair": true, "vegan": true, "quiet": false], web: "https://spiderhouseaustin.com/" , hours: "11am-2pm everyday")
        ...
        let place8 = Place(name: "The Q Austin", description: "", categories: ["lgbtq": true, "bathroom": true, "open_carry": true, "wheelchair": false, "vegan": false, "quiet": true], web: "http://www.theqaustin.org/" , hours: "Mon-Thurs 10am-7pm, Fri 1pm-5pm")
        ...
        let place10 = Place(name: "University Baptist Church", description: "church", categories: ["lgbtq": true, "bathroom": false, "open_carry": false, "wheelchair": false, "vegan": false, "quiet": true], web: "www.google.com" , hours: "Bible Study 9:30am, Service 11am")
        ...
        let place14 = Place(name: "The Iron Bear", description: "Unknown", categories: ["lgbtq": true, "bathroom": false, "open_carry": true, "wheelchair": true, "vegan": false, "quiet": false], web: "http://theironbear.com/" ,hours: "3pm-2am everyday")
        let place15 = Place(name: "Birds Barbershop", description: "Hair", categories: ["lgbtq": true, "bathroom": true, "open_carry": true, "wheelchair": false, "vegan": false, "quiet": false], web: "http://birdsbarbershop.com/" , hours: "Mon-Fri 9am-8pm, Sat 9am-7pm, Sun 10am-6pm")
        let place16 = Place(name: "Elysium", description: "Unknown", categories: ["lgbtq": true, "bathroom": false, "open_carry": true, "wheelchair": true, "vegan": false, "quiet": false], web: "http://www.elysiumonline.net/" , hours: "Mon closed, Tue-Wed 10pm-2am, Thur-Sun 9:30pm-2am")
        ...
        let place19 = Place(name: "Gender and Sexuality Center- UT campus", description: "", categories: ["lgbtq": true, "bathroom": false, "open_carry": false, "wheelchair": true, "vegan": false, "quiet": true], web: "http://ddce.utexas.edu/genderandsexuality/" , hours: "Mon-Thurs 9am to 7pm, Fri 9am to 5pm, Summer Hours: Mon-Fri 9am-5pm")
        ...
        let place21 = Place(name: "University United Methodist Church", description: "Hangout", categories: ["lgbtq": true, "bathroom": true, "open_carry": true, "wheelchair": false, "vegan": false, "quiet": true], web: "http://www.uumc.org/" , hours: "Sunday Service 8:30am/11am")
        let place22 = Place(name: "Austin's Pizza", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.austinspizza.com/stores/guadalupe/" , hours: "Open 24 hours, 7 days a week")
        let place23 = Place(name: "Fuzzy's Taco Shop", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.fuzzystacoshop.com/locations/30073-fuzzys-taco-shop-austin-tx" , hours: "10am-10pm everyday")
        let place24 = Place(name: "Juiceland", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.juiceland.com/" , hours: "Mon-Sat 7am-8pm, Sun 8am-8pm")
        let place25 = Place(name: "Kerbey Lane Cafe", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://kerbeylanecafe.com/locations/university" , hours: "Open 24 hours, 7 days a week")
        let place26 = Place(name: "Plucker's", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.pluckers.com/" , hours: "Sun-Thurs 11am-2am, Fri-Sat 11am-3am")
        let place27 = Place(name: "Torchy's Tacos", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://torchystacos.com/location/ut/" , hours: "Mon-Fri 7am-10pm, Sat-Sun 8am-10pm")
        let place28 = Place(name: "Whataburger", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://whataburger.com/" , hours: "Open 24 hours, 7 days a week")
        let place29 = Place(name: "Fresh Plus", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://freshplusaustin.com/" , hours: "8am-10pm everyday")
        let place30 = Place(name: "Taco Cabana", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.tacocabana.com/" , hours: "Open 24 hours, 7 days a week")
        let place31 = Place(name: "Tom's Tabooley", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": false, "quiet": false], web: "http://www.taboolery.com/" , hours: "11am-9pm everyday")
        let place32 = Place(name: "Trudy's Tex-Mex", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": true, "quiet": false], web: "http://www.trudys.com/" , hours: "Mon-Thurs 2pm-2am, Fri 11am-2am, Sat-Sun 9am-2am")
        let place33 = Place(name: "University Federal Credit Union", description: "Hangout", categories: ["lgbtq": false, "bathroom": false, "open_carry": true, "wheelchair": false, "vegan": false, "quiet": false], web: "http://Ufcu.org" , hours: "Mon-Fri 9am-6pm, Sat-Sun closed")
